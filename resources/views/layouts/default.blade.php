        ...
        <div class="wrapper">
            ...
            <footer class="main-footer hidden-print" style="display:grid;flex-direction:column;">
                ...
                <div class="1hidden-xs pull-left">
                    <div class="pull-left" >
                        <a target="_blank" href="https://forseti.vn" rel="noopener">Forseti-IT</a> made with <x-icon type="heart" style="color: #a94442; font-size: 10px" />
                            <span class="sr-only">love</span> by <a href="https://forseti.vn" rel="noopener">@forsetiit</a>.
                    </div>
                    <div class="pull-right">

...
'ldap_location_help'             => 'The Ldap Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'show_images_in_email_help'   => 'Hapus centang kotak ini jika instalasi Forseti-IT Anda berada di belakang VPN atau jaringan tertutup dan pengguna di luar jaringan tidak akan dapat memuat gambar yang disajikan dari instalasi ini di email mereka.',
    ...
    'support_footer_help'       => 'Tentukan siapa yang melihat tautan ke informasi pendukung dan panduan pengguna Forseti-IT',
    'version_footer'            => 'Versi pada Footer ',
    'version_footer_help'       => 'Tentukan siapa saja yang dapat melihat versi dan build number dari Forseti-IT.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Tautan ke Forseti-IT di Email',
    'show_url_in_emails_help_text'      => 'Hapus centang pada kotak ini jika anda tidak ingin menautkan kembali ke instalasi Forseti-IT di email anda. Berguna jika sebagian besar pengguna anda tidak pernah masuk. ',
    'text_pt'        => 'pt',

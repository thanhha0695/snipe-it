...
'ldap_location_help'             => 'The Ldap Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'ldap_activated_flag_help'  => 'This value is used to determine whether a synced user can login to Forseti-IT. <strong>It does not affect the ability to check items in or out to them</strong>, and should be the <strong>attribute name</strong> within your AD/LDAP, <strong>not the value</strong>. <br><br>If this field is set to a field name that does not exist in your AD/LDAP, or the value in the AD/LDAP field is set to <code>0</code> or <code>false</code>, <strong>user login will be disabled</strong>. If the value in the AD/LDAP field is set to <code>1</code> or <code>true</code> or <em>any other text</em> means the user can log in. When the field is blank in your AD, we respect the <code>userAccountControl</code> attribute, which usually allows non-suspended users to log in.',
    ...
    'login_remote_user_custom_logout_url_help' => 'If a url is provided here, users will get redirected to this URL after the user logs out of Forseti-IT. This is useful to close the user sessions of your Authentication provider correctly.',
    ...
    'snipe_version'  			=> 'Ang bersyon ng Forseti-IT',
    'support_footer'            => 'Sumusuporta ng mga Link ng Footer ',
    'support_footer_help'       => 'I-specify kung sino ang nakakakita ng mga link sa impormasyon ng Forseti-IT Support at ang mga User Manual',
    'version_footer'            => 'Version in Footer ',
    'version_footer_help'       => 'Specify who sees the Forseti-IT version and build number.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'I-link ang Forseti-IT sa mga Email',
    'show_url_in_emails_help_text'      => 'I-uncheck ang box na ito kung hindi mo gustong mag-link pabalik sa pag-install ng Forseti-IT sa mga footers ng iyong email. Ito ay kapaki-pakinabang kung karamihan sa iyong mga gumagamit ay kailanman hindi mag-login. ',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'This will attempt to delete cached barcodes. This would typically only be used if your barcode settings have changed, or if your Forseti-IT URL has changed. Barcodes will be re-generated when accessed next.',

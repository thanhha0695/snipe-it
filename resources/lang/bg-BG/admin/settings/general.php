...
'ldap_location_help'             => 'LDAP полето с локация трябва да се използва ако <strong> OU не е оказан при свързването към DN.</strong> Оставете това поле празно ако ползвате търсене по OU.',
    ...
    'load_remote_help_text'		=> 'Премахнете отметката от това квадратче, ако вашата инсталация не може да зареди скриптове от външен интернет. Това ще попречи на Forseti-IT да се опита да зареди аватари от Gravatar или други външни източници.',
    'login'                     => 'Опити за вход',
    ...
    'login_remote_user_custom_logout_url_help' => 'Ако уеб адреса е вписън тук, потребителите ще бъдат препратени към този URL след като излязат от Forseti-IT. Това е препоръчително за да се затвори сесията от доставчика на удостоверения правилно.',
    ...
    'snipe_version'  			=> 'Forseti-IT версия',
    'support_footer'            => 'Връзки към Forseti-it поддръжката във футъра',
    ...
    'version_footer_help'       => 'Определя кой ще вижда Forseti-IT версията и номера на компилация.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Връзка към Forseti-IT в имейли',
    'show_url_in_emails_help_text'      => 'Премахнете отметката от тази кутийка, ако не желаете да свържете обратно към вашата Forseti-IT инсталация в досиетата ви за електронна поща. Полезно, ако повечето от вашите потребители никога не влизат в системата.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Това ще изтрие кеша на баркодовете. Това обикновено се използва при промяна на баркод настройките или при промяна на Forseti-IT URL адреса. Баркодовете ще бъдат генерирани отново.',

...
'ldap_location_help'             => 'The Ldap Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'load_remote_help_text'		=> 'Uncheck this box if your install cannot load scripts from the outside internet. This will prevent Forseti-IT from trying load avatars from Gravatar or other outside sources.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Εάν παρέχεται ένα url εδώ, οι χρήστες θα ανακατευθυνθούν σε αυτήν τη διεύθυνση URL αφού ο χρήστης αποσυνδεθεί από το Forseti-IT. Σε περίπτωση που χρησιμοποιήτε κάποιο συγκεκριμένο πάρωχο Authentication.',
    ...
    'show_images_in_email_help'   => 'Απενεργοποιήστε αυτό το πλαίσιο αν η εγκατάσταση Forseti-IT βρίσκεται πίσω από ένα VPN ή ένα κλειστό δίκτυο και οι χρήστες έξω από το δίκτυο δεν θα μπορούν να φορτώσουν εικόνες που σερβίρονται από αυτήν την εγκατάσταση στα μηνύματα ηλεκτρονικού ταχυδρομείου τους.',
    ...
    'snipe_version'  			=> 'Forseti-It έκδοση',
    'support_footer'            => 'Σύνδεσμοι Υποσέλιδου Υποστήριξης ',
    'support_footer_help'       => 'Καθορίστε ποιος βλέπει τους συνδέσμους με τις πληροφορίες υποστήριξης Forseti-IT και το εγχειρίδιο χρήσης',
    'version_footer'            => 'Έκδοση στο υποσέλιδο ',
    'version_footer_help'       => 'Καθορίστε ποιός μπορεί να δει την έκδοση και τον αριθμό κατασκευής του Forseti-ΙΤ.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Σύνδεση με το Forseti-IT στα ηλεκτρονικά ταχυδρομεία',
    'show_url_in_emails_help_text'      => 'Καταργήστε την επιλογή αυτού του πλαισίου αν δεν θέλετε να συνδεθείτε πίσω στην εγκατάσταση Forseti-IT στα υποσέλιδα ηλεκτρονικού ταχυδρομείου σας. Χρήσιμο αν οι περισσότεροι χρήστες σας δεν συνδέονται ποτέ.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Αυτό θα προσπαθήσει να διαγράψει τους προσωρινά αποθηκευμένους barcodes. Αυτό συνήθως θα μπορούσε να χρησιμοποιηθεί μόνο αν οι ρυθμίσεις barcode έχουν αλλάξει, ή αν το URL σας Forseti-IT έχει αλλάξει. Οι γραμμωτοί κώδικες θα αναπαραχθούν όταν γίνει πρόσβαση στο επόμενο.',

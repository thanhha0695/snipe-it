...
'ldap_location_help'             => 'El campo Location (ubicación) de Ldap debe utilizarse si <strong>una OU no está siendo utilizada en el Base Bind DN (DN del enlace base).</strong> Deje este espacio en blanco si se utiliza una búsqueda OU.',
    ...
    'load_remote_help_text'		=> 'Desmarque esta casilla si su instalación no puede cargar secuencias de comandos (scripts) desde Internet . Esto evitará que Forseti-IT intente cargar avatares de Gravatar u otras fuentes externas.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Si se proporciona una URL aquí, los usuarios serán redirigidos a esta URL después de que el usuario cierre la sesión de Forseti-IT. Esto es útil para cerrar correctamente las sesiones de usuario de su proveedor de autenticación.',
    ...
    'show_images_in_email_help'   => 'Desmarque esta casilla si su instalación de Forseti-IT está detrás de una red privada o VPN y los usuarios fuera de la red no pueden cargar las imágenes publicadas desde este servidor de Forseti-IT en sus correos electrónicos.',
    ...
    'snipe_version'  			=> 'Versión de Forseti-IT',
    'support_footer'            => 'Enlace al soporte en el pie de página ',
    'support_footer_help'       => 'Especifique quién puede ver los enlaces a la información de soporte de Forseti-IT y al manual de usuario',
    'version_footer'            => 'Versión en el pie de página ',
    'version_footer_help'       => 'Especifique quién puede ver la versión de Forseti-IT y el número de compilación.',
    ...
    'width_w'        => 'ancho',
    'height_h'        => 'alto',
    'show_url_in_emails'                => 'Enlace a Forseti-IT en correos electrónicos',
    'show_url_in_emails_help_text'      => 'Desmarque esta casilla si no desea vincular su instalación de Forseti-IT en el pie de página de correo electrónico. Útil si la mayoría de sus usuarios nunca se conectan. ',
    'text_pt'        => 'puntos',
    ...
    'barcodes_help' => 'Esto intentará eliminar códigos de barras almacenados en caché. Normalmente solo se usa si la configuración del código de barras ha cambiado o si ha cambiado la URL de Forseti-IT. Los códigos de barras se volverán a generar la próxima vez que se acceda a ellos.',

...
return [
    ...
    'importing_help'        => 'Puede importar activos, accesorios, licencias, componentes, consumibles y usuarios a través del archivo CSV. <br><br>El CSV debe estar delimitado por comas y formateado con encabezados que coincidan con los de los <a href="#" target="_new">archivos CSV de muestra en la documentación</a>.',
    ...
    'webhook_test_msg'        => '¡Hola! ¡Parece que la integración de :app con Forseti-IT funciona!',

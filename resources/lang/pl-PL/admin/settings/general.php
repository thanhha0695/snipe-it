...
'ldap_location_help'             => 'Pole lokalizacji Ldap powinno być używane, jeśli <strong>nie jest używane w Bazowym Bind DN.</strong> Pozostaw to pole puste, jeśli używane jest wyszukiwanie OU.',
    ...
    'load_remote_help_text'		=> 'Odznacz to pole, jeśli instalacja nie może załadować skryptów z zewnętrznego internetu. To uniemożliwi Forseti-IT próby załadowania obrazów z Gravatar.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Jeżeli URL jest tutaj wpisany, użytkownicy zostaną przekierowani do tego adresu URL po wylogowaniu ze Forseti-IT. Jest to przydatne do prawidłowego zamknięcia sesji użytkownika twojego dostawcy uwierzytelniania.',
    ...
    'show_images_in_email_help'   => 'Odznacz to pole, jeśli twoja instalacja Forseti-IT znajduje się za siecią VPN lub siecią zamkniętą, a użytkownicy spoza sieci nie będą mogli załadować obrazów obsługiwanych przez tę instalację w swoich wiadomościach e-mail.',
    ...
    'snipe_version'  			=> 'Wersja Forseti-IT',
    'support_footer'            => 'Obsługa linków stopki ',
    'support_footer_help'       => 'Określ kto widzi linki do Forseti-IT Instrukcji Obsługi oraz Wsparcia',
    'version_footer'            => 'Wersja w stopce ',
    'version_footer_help'       => 'Określ, kto widzi wersję oraz numer kompilacji Forseti-IT.',
    ...
    'width_w'        => 'szerokość',
    'height_h'        => 'wysokość',
    'show_url_in_emails'                => 'Połącz się z Forseti-IT w wiadomościach e-mail',
    'show_url_in_emails_help_text'      => 'Usuń zaznaczenie tego pola, jeśli nie chcesz łączyć się z instalacją Forseti-IT w stopkach wiadomości e-mail. Przydatne, jeśli większość użytkowników nigdy nie loguje się.',
    'text_pt'        => 'piksel',
    ...
    'barcodes_help' => 'Spowoduje to próbę usunięcia kodów kreskowych z pamięci podręcznej. Jest to zwykle używane tylko wtedy, gdy zmieniły się ustawienia kodu kreskowego lub jeśli zmienił się adres URL Forseti-IT. Kody kreskowe zostaną wygenerowane ponownie przy następnym dostępie.',
    ...
    'help_default_will_use' => '<code>:default</code> użyje wartości z <code>:setting_name</code>. <br>Zauważ, że wartość kodów kreskowych musi być zgodna z odpowiednią specyfikacją kodu kreskowego, aby mogła zostać wygenerowana. Aby uzyskać więcej informacji, zobacz <a href="#">dokumentację <i class="fa fa-external-link"></i></a>. ',
    'asset_id'              => 'ID Aktywa',
    'data'               => 'Dane',
    'default'               => 'Domyślny',
    'none'                  => 'Brak',
